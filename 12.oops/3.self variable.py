##self variable###
'''
we can access attributes and methods inside the class.These variables are used to access instance variables and instance methods.
...
s1=Student("sita",20)  ##s1 is the reference variable
s1.details()  
