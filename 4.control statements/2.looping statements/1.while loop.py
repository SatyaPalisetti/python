##looping statement
'''
a control flow statement that repeats a block of code until a condition is true
'''
###while loop
'''
a control flow statement that allows ablock of code to be executed an iterates number of times until the condition is true
'''
while True:
    print("This is Loop")
